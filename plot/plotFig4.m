...
%% Diffusion constants vs active time, peak amplitude, Fig 4A,B
...
dFolder = '../data_in_paper/ringPlace_N200_online_06202022.mat';
load(dFolder,'tolActiTime','Ds_log','aveAmp')
...
plot(aveAmp,tolActiTime,'o','MarkerSize',4,...
...
plot(aveAmp,Ds_log(:,1),'o','MarkerSize',4,...
    'MarkerEdgeColor',greys(9,:),'LineWidth',1.5)
xlabel('Mean peak amplitude','FontSize',labelFont)
...
% ************************************************************
dFile = '../data_in_paper/pc1D_ring_learnRate_alp0_Np100_std0.01_lr0.05_bs1-09-Jun-2022.mat';
...
% ************************************************************
dFile = '../data_in_paper/ring_diff_learnRate_0608.mat';
load(dFile,'lrs','Ds')
